...
public class TemplateModule extends AbstractModule {
    ...
    public NotificationTemplateEngine thymeleafEngine() {
        ...
        return (template, variables, locale) ->
                new TemplateEngine()
                        .process(template, new Context(locale, getVariables(variables)));
    ...
    public interface NotificationTemplateEngine {
        String process(String template, JsonNode variables, Locale locale) throws IOException, TemplateException;
    }
